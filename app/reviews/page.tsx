...
// Let op: we vragen nu alléén om _type == "review"
const REVIEWS_QUERY = `
...
`;
// Vergeet niet in je component client.fetch(REVIEWS_QUERY) aan te roepen in plaats van de ALL_ARTICLES_QUERY!
  ...
  return (
    <main className="p-6 md:p-12 lg:p-16 max-w-7xl mx-auto w-full font-sans text-white">
      ...
      <header className="mb-16 border-b-2 border-gray-800 pb-12">
        ...
        <p className="text-gray-400 text-lg max-w-2xl font-light"> Curious how we evaluate games for busy parents? Read everything about our methodology in the{' '}
            <Link 
              // LET OP: Vul hier exact de slug in die je in Sanity aan deze "How we rate" pagina hebt gegeven!
              href="/how-we-rate" 
