...
// Let op: we vragen nu alléén om _type == "post" (zo heten jouw guides in Sanity)
const GUIDES_QUERY = `
...
`;
// Vergeet niet in je component client.fetch(GUIDES_QUERY) aan te roepen in plaats van de ALL_ARTICLES_QUERY!

export default async function ArticlesPage() {
  const allArticles = await client.fetch(GUIDES_QUERY);
    ...
    <main className="p-6 md:p-12 lg:p-16 max-w-7xl mx-auto w-full font-sans text-white">
      ...
      <header className="mb-16 border-b-2 border-gray-800 pb-12">
        <h1 className="text-5xl md:text-6xl font-black tracking-tight mb-4">
          The Ultimate <span className="animate-color-rotate">Guides</span>
        </h1>
